                    ...
                    <div class="row col-lg-12 ms-3">
                        <div class="col-lg-6">
                            <div class="row g-3 align-items-center col-lg-12">
                                <div class="col-lg-5">
                                    <label for="customerCode" class="required col-form-label">Mã công văn, thông báo</label>
                                    <base-validation />
                                </div>
                                <div class="col-lg-6">
                            ...
                            <div class="row g-3 align-items-center col-lg-12">
                                <div class="col-lg-5">
                                    <label for="taxCode" class="required col-form-label">Tên công văn, thông báo</label>
                                    <base-validation />
                                </div>
                                <div class="col-lg-6">
                            ...
                            <div class="row g-3 align-items-center col-lg-12">
                                <div class="col-lg-5">
                                    <label for="name" class="col-form-label">Số công văn, thông báo</label>
                                    <base-validation />
                                </div>
                                <div class="col-lg-6">
                            ...
                            <div class="row g-3 align-items-center col-lg-12">
                                <div class="col-lg-5">
                                    <div class="" style="display: grid;">
                                        <label for="created_at" class="required col-form-label">Từ ngày</label>
                                        <label for="created_at" class="col-form-label">(Ngày hiệu lực)</label>
                                    </div>
                                    <base-validation />
                                </div>
                                <div class="col-lg-6">
                            ...
                            <div class="row g-3 align-items-center col-lg-12">
                                <div class="col-lg-5" style="margin-top: -40px;">
                                    <label for="inputPassword6" class="col-form-label">Nội dung</label>
                                    <base-validation />
                                </div>
                                <div class="col-lg-6">
                                    <textarea class="form-control form-control-solid" placeholder="Nội dung" :class="{ 'input-custom-valid': errors.note}" v-model="props.customer.note" rows="3"></textarea>
                                    <base-validation :message="errors.note" />
                                </div>
                            </div>
                            <div class="row g-3 align-items-center col-lg-12" style="margin-top: 70px">
                                <div class="col-lg-5" style="margin-top: -40px;">
                                    <label for="inputPassword6" class="col-form-label" style="border-bottom: 1px solid black;">Công ty</label>
                                    <base-validation />
                                </div>
                                <!-- <div class="col-lg-6">
                                    <textarea class="form-control form-control-solid" placeholder="Nội dung" :class="{ 'input-custom-valid': errors.note}" v-model="props.customer.note" rows="3"></textarea>
                            ...
                            <div class="row g-3 align-items-center col-lg-12">
                                <div class="col-lg-5">
                                    <label for="inputPassword6" class="required col-form-label">Người gửi</label>
                                    <base-validation />
                                </div>
                                <div class="col-lg-6">
                            ...
                            <div class="row g-3 align-items-center col-lg-12">
                                <div class="col-lg-5">
                                    <label for="inputPassword6" class="required col-form-label">Người nhận</label>
                                    <base-validation />
                                </div>
                                <div class="col-lg-6">
                                    <select class="form-select"
                        ...
                        <div class="col-lg-6">
                            <div class="row g-3 align-items-center col-lg-12">
                                <div class="col-lg-4">
                                    <label for="status" class="required col-form-label">Loại</label>
                                    <base-validation />
                                </div>
                                <div class="col-lg-7">
                                    <select class="form-select" :class="{ 'input-custom-valid': errors.status_id}"
                            ...
                            <div class="row g-3 align-items-center col-lg-12">
                                <div class="col-lg-4">
                                    <label for="created_at" class="required col-form-label">Ngày lập</label>
                                    <base-validation />
                                </div>
                                <div class="col-lg-7">
                                    <input type="date" id="created_at" disabled v-model="props.customer.created_at"
                            ...
                            <div class="row g-3 align-items-center col-lg-12">
                                <div class="col-lg-4">
                                    <label for="inputPassword6" class="required col-form-label">Khách hàng</label>
                                    <base-validation />
                                </div>
                                <div class="col-lg-7">
                                    <select class="form-select"
                            ...
                            <div class="row g-3 align-items-center col-lg-12">
                                <div class="col-lg-4">
                                    <div class="" style="display: grid;">
                                        <label for="created_at" class="required col-form-label">Đến ngày</label>
                                        <label for="created_at" class="col-form-label">(Ngày hiệu lực)</label>
                                    </div>
                                    <base-validation />
                                </div>
                            ...
                            <div class="row g-3 align-items-center col-lg-12">
                                ...
                                <div class="col-lg-7">
                                    <textarea class="form-control form-control-solid" placeholder="Ghi chú" :class="{ 'input-custom-valid': errors.note}" v-model="props.customer.note" rows="3"></textarea>
                                    <base-validation :message="errors.note" />
                                </div>
                            </div>
                            <div class="row g-3 align-items-center col-lg-12" style="margin-top: 70px">
                                <div class="col-lg-5" style="margin-top: -40px;">
                                    <label style="border-bottom: 1px solid black;" for="inputPassword6" class="col-form-label">Khách hàng</label>
                                    <base-validation />
                                </div>
                                <!-- <div class="col-lg-6">
                                    <textarea class="form-control form-control-solid" placeholder="Nội dung" :class="{ 'input-custom-valid': errors.note}" v-model="props.customer.note" rows="3"></textarea>
