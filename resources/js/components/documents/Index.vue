            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap ms-5">
                <div class="d-flex align-items-center flex-wrap">
                    <div class="d-flex align-items-center me-1 flex-wrap w-auto" style="margin-left: 10px;">
                        <div class="w-auto">
                            <label class="col-form-label" for="checkCreate">Ngày lập</label>
                        </div>
                    ...
                    <div class="d-flex align-items-center flex-wrap w-auto me-2">
                        <div class="w-auto">
                            <label for="customerCode" class="col-form-label">Loại</label>
                        </div>
                        <div class="w-100px">
                            <input type="text" placeholder="Tất cả" class="form-control mb-lg-0 p-2" id="customerCode"
                  ...
                  <div class="form-check form-check-sm form-check-custom form-check-solid">
                    <input class="form-check-input" type="checkbox" value="1" data-kt-check="true"
                      data-kt-check-target=".widget-9-check" />
                                ...
                                <th class="w-400px text-center">Ngày lập</th>
                                ...
                                <th class="min-w-75px">Loại</th>
                                <th class="min-w-125px">Số công văn/thông báo</th>
                                <th class="min-w-125px">Người gửi - Người nhận (Phía công ty)</th>
                                <th class="min-w-125px">Người gửi - Người nhận (Phía khách hàng)</th>
                                <th class="min-w-125px">Ngày hiệu lực</th>
                        ...
                        <tbody class="max-h-75 overflow-auto cursor-pointer">
                            <tr>
                                <td class="h-40px fw-medium" style="background-color: rgb(243 237 179); font-size:14px;" colspan="13">
                                    Mã dữ án - Tên dự án
                                </td>
                            </tr>
