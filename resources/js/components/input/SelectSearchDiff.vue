    ...
    <div v-click-outside="() => toggleShow(false)">
        <div class="box">
            <div class="select-box" :class="{ 'active': showList, 'disabled': props.disabled }">
                ...
                <div class="options-container" v-if="showList" :style="{ top: 120 + 'px', left: left + 'px' }" style="max-width: 299px">

                    <div class="search-box">
                        <input type="text" placeholder="Tìm kiếm..." v-model="searchData" />
                    </div>
                    <div class="list" style="width: 299px">
                        <div class="option" id="1" @click="setDataSelect(null)" v-if="listData.length > 0">
                            {{ props.placeholder }}
                        </div>
                        <div class="option"
                            ...
                            <span v-if="typeof (props.keyDisplay) === 'string'" :title="item[props.keyDisplay]"
                             class="break-text d-block" style="max-width:299px; white-space: nowrap;">{{ item[props.keyDisplay] }}</span>
                            <span v-else>
