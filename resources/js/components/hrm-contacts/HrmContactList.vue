                        ...
                        >
                            ...
                            <td>
                                <div style="padding: 5px;">
                                    - Số điện thoại chính:{{ item.contact_mobile }} <br/>
                                    - Số điện thoại phụ:{{ item.contact_mobile_2 }}<br/>
                                    - Số điện thoại người thân:{{ item.relative_phone_number }}<br/>
                                </div>
                            </td>
                            <td class="break-text">
                                {{ item.contact_email }}
                            ...
                            <td class="break-text">
                                {{ `${ moment(new Date( item.contact_birthday)).format('DD/MM/YYYY')}` }}
                            </td>

                            <td>{{ item.permanent_address }}</td>
                            <td>{{ item.temporary_address }}</td>

                            <td>{{ item.contact_tax_code }}</td>
                        </tr>
                        </tbody>
            ...
            <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered max-h-100">
                <div class="modal-content">
                        ...
                        <div class="row col-lg-12 ms-1 mb-10 form" style="border-bottom: 1px solid rgb(212, 212, 212);">
                            <div class="col-lg-6">
                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="customerCode" class="required col-form-label">Mã nhân viên</label>
                                        <base-validation />
                                    </div>
                                ...
                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="taxCode" class="required col-form-label">Họ tên nhân viên</label>
                                        <base-validation />
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="name" class="required col-form-label">Email</label>
                                        <base-validation />
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row g-3 align-items-center col-lg-12">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        >
                                            <input
                                                ...
                                                v-model="dataUpdate.contact_gender"
                                                type="radio"
                                                name="gender"
                                                :value="1"
                                            />
                                    ...
                                    <base-validation :message="errors?.contact_gender" />
                                    </div>
                                </div>

                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="name" class="required col-form-label">Ngày sinh</label>
                                        <base-validation />
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="taxCode" class=" col-form-label">Quốc gia
                                        </label>
                                        <base-validation />
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="status" class=" col-form-label">Số CMTND/CCCD</label>
                                        <base-validation />
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="status" class=" col-form-label">Ngày cấp CMTND/CCCD</label>
                                        <base-validation />
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="status" class=" col-form-label">Nơi cấp CMTND/CCCD</label>
                                        <base-validation />
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="status" class=" col-form-label">Địa chỉ thường trú</label>
                                        <base-validation />
                                    </div>
                                    <div class="col-lg-9">
                                        <input  :disabled="detailView" type="text" v-model="dataUpdate.permanent_address"
                                               class="form-control mb-lg-0 p-2"
                                        />
                                        <base-validation :message="errors?.permanent_address" />
                                    </div>
                                </div>

                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="status" class=" col-form-label">Địa chỉ tạm trú</label>
                                        <base-validation />
                                    </div>
                                    <div class="col-lg-9">
                                        <input  :disabled="detailView" type="text" v-model="dataUpdate.temporary_address"
                                               class="form-control mb-lg-0 p-2"
                                        />
                                        <base-validation :message="errors?.temporary_address" />
                                    </div>
                                </div>

                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="status" class=" col-form-label">Nguyên quán</label>
                                        <base-validation />
                                    </div>
                                    <div class="col-lg-9">
                                        <input  :disabled="detailView" type="text" v-model="dataUpdate.contact_home_town"
                                               class="form-control mb-lg-0 p-2"
                                        />
                                        <base-validation :message="errors?.contact_home_town" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="customerCode" class="required col-form-label">Bộ phận</label>
                                        <base-validation />
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="taxCode" class=" col-form-label">Ngân hàng
                                        </label>
                                        <base-validation />
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="taxCode" class=" col-form-label">Số tài khoản ngân hàng
                                        </label>
                                        <base-validation />
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="taxCode" class=" col-form-label">Mã số thuế cá nhân
                                        </label>
                                        <base-validation />
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="taxCode" class=" col-form-label">Ngày cấp mã số thuế cá nhân
                                        </label>
                                        <base-validation />
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="taxCode" class=" col-form-label">Facebook
                                        </label>
                                        <base-validation />
                                    </div>
                                    <div class="col-lg-9">
                                        <input  :disabled="detailView" type="text"  v-model="dataUpdate.contact_facebook"
                                               class="form-control mb-lg-0 p-2"
                                        />
                                        <base-validation :message="errors?.contact_facebook" />
                                    </div>
                                </div>

                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="taxCode" class=" col-form-label">Zalo
                                        </label>
                                        <base-validation />
                                    </div>
                                    <div class="col-lg-9">
                                        <input  :disabled="detailView" type="text"  v-model="dataUpdate.contact_zalo"
                                               class="form-control mb-lg-0 p-2"
                                        />
                                        <base-validation :message="errors?.contact_zalo" />
                                    </div>
                                </div>

                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="customer_name" class="required col-form-label">Số điện thoại	</label>
                                        <base-validation />
                                    </div>
                                    <div class="col-lg-9">
                                        <input  :disabled="detailView" type="text"  v-model="dataUpdate.contact_mobile"
                                               class="form-control mb-lg-0 p-2"
                                        />
                                        <base-validation :message="errors?.contact_mobile" />
                                    </div>
                                </div>

                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="name" class=" col-form-label">Số điện thoại phụ</label>
                                        <base-validation />
                                    </div>
                                    <div class="col-lg-9">
                                        <input  :disabled="detailView" type="text" v-model="dataUpdate.contact_mobile_2"
                                               class="form-control mb-lg-0 p-2"
                                        />
                                        <base-validation :message="errors?.contact_mobile_2" />
                                    </div>
                                </div>

                                <div class="row g-3 align-items-center col-lg-12">
                                    <div class="col-lg-3">
                                        <label for="name" class=" col-form-label">Số điện thoại người thân</label>
                                        <base-validation />
                                    </div>
                                    <div class="col-lg-9">
                                        <input  :disabled="detailView" type="text" v-model="dataUpdate.relative_phone_number"
                                               class="form-control mb-lg-0 p-2"
                                        />
                                        <base-validation :message="errors?.relative_phone_number" />
                                    </div>
                                </div>
                    ...
                    <div class="modal-footer" v-if = "! detailView" >
                        ...
                        <button type="button" class="btn btn-function me-4"  @click.prevent="handleUpdateHrmContact()">
