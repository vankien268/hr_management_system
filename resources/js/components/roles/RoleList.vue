            ...
            <div class="card-toolbar">
                ...
                <div class="align-items-right">
                    <a
                        ...
                        v-if="props.btnAdd"
                    >
                        <i class="ki-duotone ki-plus fs-2"></i>Thêm nhóm quyền</a
                    >
                </div>
                <!--begin::Menu 2-->
            </div>
                ...
                >
                    ...
                    <thead>
                        <tr class="fw-bold text-muted">
                            ...
                            <th class="w-200px">Tên nhóm quyền</th>
                            <th class="w-150px">Trạng thái</th>
                            <th class="w-125px">Quyền</th>
                    ...
                    <tbody>
                        <tr v-for="(item, index) in roles" :key="index">
                            ...
                            <td>
                                <span
                                    class="text-dark text-hover-primary text-content w-200px break-text d-block pb-1 mt-1"
                                    >{{ item.name }}</span
                                >
                            </td>
                            <td>
                                <div
                                    class="text-red text-hover-primary d-block mb-1 text-content w-150px"
                            ...
                            <td class="w-125px text-center">
                                <a
                                    href="#"
                                    @click="clickAssignRole(item.id)"
                                    v-if="item.isEdit"
                                >
                                    <i
                                        class="fa-solid fa-gear fs-2 icon-roles"
                                    >
