        ...
        <section class="error">
            ...
            <div class="error__content">
                <div class="error__message message">
                    ...
                    <p class="message__text">Chúng tôi xin lỗi, trang bạn đang tìm kiếm không được tìm thấy ở đây. Liên
                        kết bạn theo dõi có thể bị hỏng hoặc không còn tồn tại. Vui lòng thử lại.</p>
                </div>
                <div class="error__nav e-nav">
                    {{-- <a href="{{ url()->previous() }}" class="e-nav__link"></a> --}}
                    <a href="/dashboard" class="e-nav__link"></a>
                </div>
            </div>
            <!-- END Content -->
