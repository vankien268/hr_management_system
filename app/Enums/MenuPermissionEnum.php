...
final class MenuPermissionEnum extends Enum
{
    ...
    const MenuPer = [
        ['id' => 15, 'code' => 'VIEW_REQUEST_TICKET', 'route_name' => 'admin.request-tickets.index'],
        ['id' => 20, 'code' => 'VIEW_WORKFLOW', 'route_name' => 'admin.workflow.index'],
...
//        ['id' => 108, 'code' => 'VIEW_CUSTOMER', 'route_name' => 'admin.customers.view'],
        ...
        ['id' => 112, 'code' => 'VIEW_ALLOWANCE', 'route_name' => 'admin.allowances.view'],
        ['id' => 113, 'code' => 'VIEW_TAXES', 'route_name' => 'admin.taxes.index'],
        ['id' => 114, 'code' => 'VIEW_INTERNAL_FUND', 'route_name' => 'admin.internal-fund.index'],
        ['id' => 115, 'code' => 'VIEW_USER_LEAVE_DAYS', 'route_name' => 'admin.user-leave-days.index'],
        ['id' => 116, 'code' => 'VIEW_DECLARE_ROLE', 'route_name' => 'admin.roles.index'],
        ['id' => 117, 'code' => 'VIEW_USER', 'route_name' => 'admin.users.index'],
        ['id' => 9, 'code' => 'VIEW_LIST_USER', 'route_name' => 'admin.users.index'],
        ['id' => 73, 'code' => 'VIEW_HRM_CONTACT', 'route_name' => 'admin.hrm-contacts.index'],
        ['id' => 103, 'code' => 'VIEW_HRM_CONTRACT', 'route_name' => 'admin.hrm-contracts.index'],
