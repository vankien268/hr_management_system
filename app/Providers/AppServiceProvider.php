...
use App\Repositories\WorkingShiftSettingRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->app->singleton(ISalaryGradeRepository::class, SalaryGradeRepository::class);
        $this->app->singleton(ITimekeepingRepository::class, TimekeepingRepository::class);
        $this->app->singleton(IWorkingShiftSettingRepository::class, WorkingShiftSettingRepository::class);
        $this->app->singleton(ISalariesRepository::class, SalariesRepository::class);
