...
class ProductStoreRequest extends FormRequest
{
    ...
    {
        return [
            'code' => ['required', 'unique:products,code', 'max:30', 'regex:/^[0-9A-Z.\_]+$/'],
    ...
    {
        return [
            'code.required' => trans('Mã sản phẩm không bỏ trống.'),
            'code.unique' => trans('Mã sản phẩm đã tồn tại.'),
            'code.max' => trans('Mã sản phẩm không quá 30 ký tự.'),
            'code.regex' => trans('Mã sản phẩm phải là số hoặc chữ hoa, không chứ ký tự đặc biệt.'),
