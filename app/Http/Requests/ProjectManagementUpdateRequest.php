...
class ProjectManagementUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
       return [
            ...
            'contact.data.*.contact_id' => ['required', 'numeric', 'exists:contacts,id'],
    ...
    public function messages()
    {
        return [
            ...
            // // người đại diện
            'contact.data.*.contact_id.required' => trans('Mã khách hàng không hợp lệ.'),
            'contact.data.*.contact_id.numeric' => trans('Mã khách hàng không hợp lệ.'),
            'contact.data.*.contact_id.exists' => trans('Mã khách hàng không hợp lệ.'),
