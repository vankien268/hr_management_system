        ...
        return [
            ...
            'tax_code' => [
                function ($attribute, $value, $fail) use ($customerId) {
                    ...
                    $checkTaxCodeUnique = $this->customerRepository->model()->where('tax_code', 'like', $value)->where('id', '!=', $customerId)->first();
